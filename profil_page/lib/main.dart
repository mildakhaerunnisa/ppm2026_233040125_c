...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  const CircleAvatar(
                    radius: 50,
                    // Tugas Mandiri 1: Menampilkan foto/avatar
            ...
            const _SectionCard(
              ...
              title: 'Tentang Saya',
              content:
                  'Saya adalah seorang mahasiswa yang antusias dalam pengembangan aplikasi mobile menggunakan Flutter. Senang belajar hal-hal baru dan berkontribusi dalam proyek open source.',
            ),
            const _SectionCard(
              icon: Icons.school,
              title: 'Pendidikan',
              content: 'Universitas Indonesia — Sistem Informasi\nIPK: 3.90',
            ),
            const _SectionCard(
              icon: Icons.favorite,
              title: 'Hobi & Minat',
              content: 'Coding • Membaca • Traveling • Fotografi',
            ),
      ...
      // Tugas Mandiri 4: FAB dengan SnackBar
